...
local gsmtapv3_nr_rrc_subtypes = {
    ...
    -- All SIBs use BCCH-DL-SCH dissector
    [0x0207] = { check_and_get_dissector("nr-rrc.bcch.dl.sch"), "SIB1" },
    [0x0208] = { check_and_get_dissector("nr-rrc.bcch.dl.sch"), "SIB2" },
    [0x0209] = { check_and_get_dissector("nr-rrc.bcch.dl.sch"), "SIB3" },
    [0x020a] = { check_and_get_dissector("nr-rrc.bcch.dl.sch"), "SIB4" },
    [0x020b] = { check_and_get_dissector("nr-rrc.bcch.dl.sch"), "SIB5" },
    [0x020c] = { check_and_get_dissector("nr-rrc.bcch.dl.sch"), "SIB6" },
    [0x020d] = { check_and_get_dissector("nr-rrc.bcch.dl.sch"), "SIB7" },
    [0x020e] = { check_and_get_dissector("nr-rrc.bcch.dl.sch"), "SIB8" },
    [0x020f] = { check_and_get_dissector("nr-rrc.bcch.dl.sch"), "SIB9" },
    [0x0210] = { check_and_get_dissector("nr-rrc.bcch.dl.sch"), "SIB10" },
    [0x0211] = { check_and_get_dissector("nr-rrc.bcch.dl.sch"), "SIB11" },
    [0x0212] = { check_and_get_dissector("nr-rrc.bcch.dl.sch"), "SIB12" },
    [0x0213] = { check_and_get_dissector("nr-rrc.bcch.dl.sch"), "SIB13" },
    [0x0214] = { check_and_get_dissector("nr-rrc.bcch.dl.sch"), "SIB14" },
    [0x0215] = { check_and_get_dissector("nr-rrc.bcch.dl.sch"), "SIB15" },
    [0x0216] = { check_and_get_dissector("nr-rrc.bcch.dl.sch"), "SIB16" },
    [0x0217] = { check_and_get_dissector("nr-rrc.bcch.dl.sch"), "SIB17" },
    [0x0218] = { check_and_get_dissector("nr-rrc.bcch.dl.sch"), "SIB18" },
    [0x0219] = { check_and_get_dissector("nr-rrc.bcch.dl.sch"), "SIB19" },
    [0x021a] = { check_and_get_dissector("nr-rrc.bcch.dl.sch"), "SIB20" },
    [0x021b] = { check_and_get_dissector("nr-rrc.bcch.dl.sch"), "SIB21" },
    [0x021c] = { check_and_get_dissector("nr-rrc.bcch.dl.sch"), "SIB22" },
    [0x021d] = { check_and_get_dissector("nr-rrc.bcch.dl.sch"), "SIB23" },
    [0x021e] = { check_and_get_dissector("nr-rrc.bcch.dl.sch"), "SIB24" },
    [0x021f] = { check_and_get_dissector("nr-rrc.bcch.dl.sch"), "SIB25" },
    [0x0220] = { check_and_get_dissector("nr-rrc.bcch.dl.sch"), "SIB17bis" }
}
...
function gsmtapv3_parse_metadata(t, buffer, buffer_len)
    ...
    while offset < (buffer_len) do
        ...
        t:add(F_gsmtapv3_md_tlv_type, buffer(offset, 2)):set_text(type_string)
...
function gsmtap_wrapper_proto.dissector(tvbuffer, pinfo, treeitem)
    ...
    if version == 3 then
        ...
        local child, hdr_len_value = t:add(F_gsmtapv3_header_len, tvbuffer(2, 2))
                                   :set_text(string.format("Maximum header length: %d bytes", hdr_len * 4))
